...
namespace LeadProcess
{
    public class ProgramFetchXMLForTask
    {
       ...
       // public static String id = "437262B2-41B6-E211-9007-E41F13BE0AF6";
        ...
        public static int fetchCount = 3;
        ...
        public static void Run(OrganizationServiceProxy service)
        {
            ...
            var fetchcountXMLAll = "<fetch distinct=\"true\" mapping=\"logical\" aggregate=\"true\">" +
                   ...
                   "</filter>" +
                   " <link-entity name=\"activityparty\" from=\"activityid\" to=\"activityid\" alias=\"at\">" +
                   "     <link-entity name=\"account\" from=\"accountid\" to=\"partyid\" alias=\"au\"/>" +
                   "     <link-entity name=\"task\" from=\"activityid\" to=\"activityid\" alias=\"bd\" />" +
                   "</link-entity>" +
                   "  </entity>" +
                   "</fetch>";
            ...
            var fetchPagingActivityMainEntity = "<fetch distinct=\"true\" mapping=\"logical\">" +
                    "  <entity name=\"activitypointer\" >" +
                    "  <filter type=\"and\" >" +
                    "   <condition attribute=\"activitytypecode\" operator=\"neq\" value=\"4401\" />" + //4401 - campaignresponse--
                        openFilter +
        ...
        public static void PrintResult(string fetchcountXMLAll, string pagingCookie, int pageNumber, int fetchCount, OrganizationServiceProxy service)
        {
            while (true)
            {
                ...
                {
                    Debug.WriteLine("fetchPaging2 Activities Total record");
